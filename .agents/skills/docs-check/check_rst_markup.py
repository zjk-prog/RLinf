...
Usage::
    ...
    python3 .agents/skills/docs-check/check_rst_markup.py            # all docs
    python3 .agents/skills/docs-check/check_rst_markup.py FILE...    # subset
    python3 .agents/skills/docs-check/check_rst_markup.py --errors-only
